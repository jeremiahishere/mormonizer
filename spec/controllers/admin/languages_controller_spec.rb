...
describe Admin::LanguagesController do
  ...
  # Admin::Language. As you add validations to Admin::Language, be sure to
  ...
  describe "GET index" do
    it "assigns all admin_languages as @admin_languages" do
      language = Admin::Language.create! valid_attributes
      get :index
      assigns(:admin_languages).should eq([language])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new language as @language" do
      get :new
      assigns(:language).should be_a_new(Admin::Language)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved language as @language" do
        ...
        Admin::Language.any_instance.stub(:save).and_return(false)
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested language" do
        language = Admin::Language.create! valid_attributes
        # Assuming there are no other admin_languages in the database, this
        # specifies that the Admin::Language created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Language.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
